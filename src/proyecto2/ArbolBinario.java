...
/**
 * Clase para los nodos del árbol binario de expresiones
 *
 * @author luisa
 */
public class ArbolBinario {
    ...
    /**
     * Agrega nodo usando la busqueda del padre
     *
     * @param nodoNuevo: nodo a agregar
     * @param datosPadre: padre del nuevo nodo
     * @param lado: qué hijo será: si izquierdo o derecho
     */
